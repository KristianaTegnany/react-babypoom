  ...
  return (
    <Icon viewBox="0 0 100 100" {...iconProps}>
      ...
      <path
        ...
        c-0.1,0,0,22.8,0,22.8c0,0-62,0-62,0c0,0,0.1-22.8,0-22.8c0-2.3,1.4-3.8,2.9-3.4c1.3,0.4,3.2,3.9,7.9,3.6c4.8-0.3,7.3-4.8,7.3-8.4
        c0-3.6-2.5-8.2-7.3-8.4c-4.7-0.3-6.6,3.3-7.9,3.6C20.2,45.6,19,44,19,41.8C19,41.8,19,19,19,19z"
        fill={`url(#${id})`}
      />
    </Icon>
  )
