    ...
    return (
      <Page>
        <PresentationPanel styleName="card-presentation-panel">
          <Title
            label={t(MSG.firstname)}
            description={t(MSG.description, { babyName: bpoom.baby_name })}
            boxClassName={'bg-decoration-2'}
            styleName={'titleFirstname'}
          />
        </PresentationPanel>
