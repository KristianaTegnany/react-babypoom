...
export default function computeThemeColors(color1, color2, pattern = '', color3 = '#f2f2f2', color4 = '#f2f2f2') {
  let isDarkColor1 = isDarkContrast(color1)
  let isDarkColor2 = isDarkContrast(color2)
  ...
  const theme = {
    ...
    '--background-pattern': `url(${pattern})`,
    '--brand-header': color3, // 1E
    '--brand-footer': color4, // 1E
  }
