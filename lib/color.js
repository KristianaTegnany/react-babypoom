...
export { lighten, rgba, darken, isDark };
...
function hslaToRgba(color) {
  let h = color[0], s = color[1] / 100, l = color[2] / 100, a = color[3];
  ...
  switch(huePrime | 0) {
    case 0: return [v0, v1, v2, a];
    case 1: return [v1, v0, v2, a];
    case 2: return [v2, v0, v1, a];
    case 3: return [v2, v1, v0, a];
    case 4: return [v1, v2, v0, a];
    case 5: return [v0, v2, v1, a];
  }
}
