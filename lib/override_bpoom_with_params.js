...
import { createPhotoURLs, getPhoto } from './get-photo'
...
export default function overrideBpoom(bpoom, params, canEdit) {
  if (params.aha) {
    ...
    bpoom.card_url = cardThumbnailURL({
      cardId: bpoom.card_id,
      bpoomUuid: getPhoto(bpoom.photo_urls, 'thumbnail') ? bpoom.uuid : 0,
      cardParams,
    })
