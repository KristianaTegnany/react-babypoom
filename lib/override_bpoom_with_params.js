...
export default function overrideBpoom(bpoom, params, canEdit) {
  if ((params && params['aha']) || (params && params['queryParams'] && params['queryParams']['aha'])) {
    ...
    bpoom['parent_1_photo'] = 'uploads/518ff3/0aefa829-2833-4ce1-82b1-ea69fd9b973d/original/pic'
    bpoom['parent_2_photo'] = 'uploads/518ff3/e9e69a25-f2ff-4e23-b3b3-004b8d6dd849/original/pic'
